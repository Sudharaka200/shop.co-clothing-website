        ...
        <section>
            <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
                ...
                <ul class="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <?php $sql = "SELECT * FROM new_arrival_products ORDER BY N_product_id DESC";
                        ...
                        <a href="../pages/productOverview.php?id=<?php echo $row['N_product_id']; ?>" class="group block overflow-hidden">
                            ...
                            <div class="relative bg-white pt-3">
                                <h3 class="text-xs text-gray-700 group-hover:underline group-hover:underline-offset-4 no-underline">
                                    <?php echo $row["N_product_name"] ?>
                                </h3>

                                <p class="mt-2">
                                    <span class="sr-only"> Regular Price </span>

                                    <span class="tracking-wider text-gray-900 no-underline"> £<?php echo $row["N_product_price"] ?></span>
                                </p>
                            </div>
                        </a>
                    </li>
